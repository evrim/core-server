...
(defhtml-tag address :core :event :i18n)
(defhtml-empty-tag area :core :event :i18n alt accesskey coords href nohref
		   onblur onfocus shape tabindex)
(defhtml-tag b :core :event :i18n)
(defhtml-empty-tag base href)
(defhtml-tag bdo :i18n id style title)
(defhtml-tag big :core :event :i18n)
(defhtml-tag blockquote :core :event :i18n cite)
(defhtml-tag body :core :i18n :event onload onunload)
(defhtml-empty-tag br :core)
(defhtml-tag button :core :event :i18n accesskey disabled name onblur
	     onfocus tabindex type value)
(defhtml-tag caption :core :event :i18n)
(defhtml-tag cite :core :event :i18n)
(defhtml-tag code :core :event :i18n)
...
(defhtml-tag dd :core :event :i18n)
(defhtml-tag del :core :event :i18n cite datetime)
(defhtml-tag dfn :core :event :i18n)
(defhtml-tag div :core :event :i18n dojo-type open)
(defhtml-tag dl :core :event :i18n)
(defhtml-tag dt :core :event :i18n)
(defhtml-tag em :core :event :i18n)
(defhtml-tag fieldset :core :event :i18n)
...
(defhtml-tag h1 :core :event :i18n)
(defhtml-tag h2 :core :event :i18n)
(defhtml-tag h3 :core :event :i18n)
(defhtml-tag h4 :core :event :i18n)
(defhtml-tag h5 :core :event :i18n)
(defhtml-tag h6 :core :event :i18n)
(defhtml-tag head :i18n profile)
(defhtml-empty-tag hr :core :event width align)
...
(defhtml-tag i :core :event :i18n)
(defhtml-tag iframe :core frameborder longdesc marginheight marginwidth name scrolling src)
(defhtml-empty-tag img :core :event :i18n alt src height ismap longdesc usemap width)
...
(defhtml-tag kbd :core :event :i18n)
(defhtml-tag label :core :event :i18n accesskey for onblur onfocus)
(defhtml-tag legend :core :event :i18n accesskey)
(defhtml-tag li :core :event :i18n)
(defhtml-tag link :core :event :i18n charset href hreflang media rel rev type)
(defhtml-tag map :core :event :i18n name)
...
(defhtml-tag small :core :event :i18n)
(defhtml-tag span :core :event :i18n)
(defhtml-tag strong :core :event :i18n)
(defhtml-tag style :i18n type media title)
(defhtml-tag sub :core :event :i18n)
(defhtml-tag sup :core :event :i18n)
...
(defhtml-tag tfoot :core :event :i18n)
...
(defhtml-tag tt :core :event :i18n)
(defhtml-tag ul :core :event :i18n)
(defhtml-tag var :core :event :i18n)
